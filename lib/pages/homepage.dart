...
class _HomepageState extends State<Homepage> {
  List itemsDishes = const [   Sliderwheel(), 
         Padding(
           padding: EdgeInsets.all(8.0),
           child: Text('Quick Access', textAlign: TextAlign.left,style: TextStyle(fontWeight: FontWeight.bold,fontSize:20.0,color: Colors.black ),),
         ),
         QuickAccess(),
       Miscellaneous(),
    ]; 
