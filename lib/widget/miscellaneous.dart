         ...
         Padding(
           ...
           child: Row(
              ...
              GestureDetector(
               ...
               MaterialPageRoute(builder: (context) => const Latest()),
                ...
                children: [
                  ...
                  const Text("Latest",style: TextStyle(fontSize: 14.0,color: Colors.black),),
                ],
                        ),
                   ),
              ),Container(
            ...
            child:  Column(
              ...
              children: [
                Image.asset('assets/images/flutter-logo.png'),
                const Text("Donors",style: TextStyle(fontSize: 14.0,color: Colors.black),),
              ],
            ),
                 )]),
         ),   Padding(
            ...
            children: [
              GestureDetector(
               ...
               MaterialPageRoute(builder: (context) => const Gallery()),
                ...
                children: [
                  Image.asset('assets/images/flutter-logo.png'),
                  const Text("Gallery",style: TextStyle(fontSize: 14.0,color: Colors.black),),
                ],
                        ),
                   ),
              ),Container(
